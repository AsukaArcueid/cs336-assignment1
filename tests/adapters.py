...
from cs336_basics.transformer import Linear, Embedding, RMSNorm, SiLU, SwiGLU, RotaryPositionalEmbedding, softmax, scaled_dot_product_attention, multihead_self_attention, multihead_self_attention_with_rope, TransformerBlock,Transformer, cross_entropy, AdamW, get_lr_cosine_schedule, gradient_clipping, get_batch, save_checkpoint, load_checkpoint
...
def run_transformer_lm(
    ...
    """
    transformer=Transformer(vocab_size,context_length,d_model,num_layers,num_heads,d_ff,rope_theta,weights)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return tokenize(input_path,vocab_size,special_tokens,kwargs.get("num_workers",6))
